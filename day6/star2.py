...
if __name__ == "__main__":
    ...
    direction = (-1, 0)
    cur_i, cur_j = saved_i, saved_j
    while 0 <= cur_i < MAX_I and 0 <= cur_j < MAX_J:
        if is_next_cell_can_be_an_obstl(cur_i, cur_j, direction):
            res += 1
            print(res)
        #
        next_cords = get_next_cords(cur_i, cur_j, direction)
        cords_for_obstcl.add(next_cords)
